...
ServerModel _$ServerModelFromJson(Map<String, dynamic> json) => ServerModel(
  ...
  secondaryConnectionAddress: json['secondary_connection_address'] as String?,
  secondaryConnectionProtocol: json['secondary_connection_protocol'] as String?,
  ...
  pushRegistered: Cast.castToBool(json['onesignal_registered']),
  plexPass: Cast.castToBool(json['plex_pass']),
  dateFormat: json['date_format'] as String?,
  timeFormat: json['time_format'] as String?,
  customHeaders: ServerModel._customHeadersFromJson(
    json['custom_headers'] as String,
  ),
);

Map<String, dynamic> _$ServerModelToJson(
  ...
  'onesignal_registered': Cast.castToInt(instance.pushRegistered),
  'plex_pass': Cast.castToInt(instance.plexPass),
  'date_format': instance.dateFormat,
  'time_format': instance.timeFormat,
  'custom_headers': ServerModel._customHeadersToJson(instance.customHeaders),
};
