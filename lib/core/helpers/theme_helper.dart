  ...
  static ThemeData tautulli({
    ...
    return ThemeData(
      ...
      colorScheme: SeedColorScheme.fromSeeds(
        ...
        primaryKey: enhancement == ThemeEnhancementType.ultraContrastDark ? const Color(0xffffcd38) : PlexColorPalette.primaryGold,
        secondaryKey: enhancement == ThemeEnhancementType.ultraContrastDark ? const Color(0xff3fb9e9) : PlexColorPalette.blue,
        tertiaryKey: enhancement == ThemeEnhancementType.ultraContrastDark ? const Color(0xffc1de8c) : PlexColorPalette.seaGreen,
        primary: enhancement == ThemeEnhancementType.ultraContrastDark ? const Color(0xffffcd38) : PlexColorPalette.primaryGold,
        ...
        secondary: enhancement == ThemeEnhancementType.ultraContrastDark ? const Color(0xff3fb9e9) : PlexColorPalette.blue,
        onSecondary: enhancement == ThemeEnhancementType.ultraContrastDark ? const Color(0xff0d0d0d) : TautulliColorPalette.notWhite,
        secondaryContainer: enhancement == ThemeEnhancementType.ultraContrastDark ? const Color(0xff1d87b4) : PlexColorPalette.blue,
        onSecondaryContainer: enhancement == ThemeEnhancementType.ultraContrastDark ? Colors.white : TautulliColorPalette.notWhite,
        tertiary: enhancement == ThemeEnhancementType.ultraContrastDark ? const Color(0xffc1de8c) : PlexColorPalette.seaGreen,
        onTertiary: enhancement == ThemeEnhancementType.ultraContrastDark ? const Color(0xff0d0d0d) : TautulliColorPalette.notWhite,
        tertiaryContainer: enhancement == ThemeEnhancementType.ultraContrastDark ? const Color(0xff80ab30) : PlexColorPalette.seaGreen,
