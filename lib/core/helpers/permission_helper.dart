...
/// still pending (e.g. the OneSignal consent switch is tapped again before the
/// system prompt resolves). Swallow that specific error so the redundant tap is
/// a no-op instead of an uncaught crash.
