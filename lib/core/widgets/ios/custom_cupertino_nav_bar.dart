//* Added `enableBackgroundFilterBlur: false` as some pages use a transparent navbar with a color beneath and this caused bleeding issues between the two
...
bool _isTransitionable(BuildContext context) {
  ...
  // the way out.
  return route is PageRoute && !route.fullscreenDialog && !CupertinoSheetRoute.hasParentSheet(context);
}
      ...
      navBar = ConstrainedBox(
        ...
        child: Column(
          children: <Widget>[
            ...
            if (widget.bottom != null) SizedBox(height: bottomHeight, child: components.navBarBottom),
          ],
        ),
      );
    } else {
...
class _CupertinoSliverNavigationBarState extends State<CupertinoSliverNavigationBar> with TickerProviderStateMixin {
  ...
  void _handleScrollChange() {
    ...
    double? target;
    final double bottomScrollOffset = widget.bottomMode == NavigationBarBottomMode.always ? 0.0 : _bottomHeight;
    final bool canScrollBottom = (widget._searchable || widget.bottom != null) && bottomScrollOffset > 0.0;
    ...
    } else if (position.pixels > bottomScrollOffset && position.pixels < bottomScrollOffset + scaledLargeTitleHeight) {
  ...
  Widget build(BuildContext context) {
    final _NavigationBarStaticComponents components = _NavigationBarStaticComponents(
      keys: keys,
      route: ModalRoute.of(context),
      userLeading: widget.leading != null ? Visibility(visible: !searchIsActive, child: widget.leading!) : null,
      automaticallyImplyLeading: widget.automaticallyImplyLeading,
      ...
      userTrailing: widget.trailing != null ? Visibility(visible: !searchIsActive, child: widget.trailing!) : null,
      userLargeTitle: widget.largeTitle,
      userBottom:
          (widget._searchable
              ? searchIsActive
        ...
        builder: (BuildContext context, Widget? child) {
          return SliverPersistentHeader(
            ...
            delegate: _LargeTitleNavigationBarSliverDelegate(
              ...
              stretchConfiguration: widget.stretch && !searchIsActive ? OverScrollHeaderStretchConfiguration() : null,
              enableBackgroundFilterBlur: widget.enableBackgroundFilterBlur,
...
class _PersistentNavigationBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (leading == null && backChevron != null && backLabel != null && !CupertinoSheetRoute.hasParentSheet(context)) {
        ...
        return LayoutBuilder(
          builder: (BuildContext context, BoxConstraints constraints) {
            return Row(
              children: <Widget>[
                SizedBox(
                  width: constraints.maxWidth - (_kSearchFieldCancelButtonWidth * animationController.value),
                  child: child,
                ),
...
class _NavigationBarTransition extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> children = <Widget>[
      if (componentsTransition.bottomNavBarBackground != null) componentsTransition.bottomNavBarBackground!,
      ...
      if (componentsTransition.topNavBarBackground != null) componentsTransition.topNavBarBackground!,
...
class _NavigationBarComponentsTransition {
  ...
  _FixedSizeSlidingTransition slideFromLeadingEdge({
    ...
    return _FixedSizeSlidingTransition(
      isLTR: isLTR,
      offsetAnimation: animation.drive(CurveTween(curve: curve)).drive(anchorMovementInTransitionBox),
  ...
  Widget? get bottomNavBarBackground {
    if (bottomBackgroundColor == null || (bottomLargeExpanded && bottomAutomaticBackgroundVisibility)) {
      return null;
    }
  ...
  Widget? get bottomNavBarBottom {
    final KeyedSubtree? bottomNavBarBottom = bottomComponents.navBarBottomKey.currentWidget as KeyedSubtree?;
  ...
  Widget? get topNavBarBottom {
    final KeyedSubtree? topNavBarBottom = topComponents.navBarBottomKey.currentWidget as KeyedSubtree?;
