  ...
  "data": [
      ...
      "changes": [
        {
          "type": "new",
          "detail":
              "Introducing App Styles! There is now a Cupertino App Style to give iOS users a more native look. This style is the default on Apple devices, but all devices can freely switch between the Material and Cupertino styles under Settings > Appearance.",
        },
        {
          "type": "improvement",
          "detail": "Background images are now custom gradients based on the colors of the source image.",
        },
        {
          "type": "improvement",
          "detail": "Changed how sensitive items look when Mask Sensitive Info is enabled.",
        },
        {
          "type": "improvement",
          "detail": "Update Flutter to 3.44.1 and update all packages.",
        },
        {
          "type": "improvement",
          "detail": "The Themes setting page has been renamed to Appearance.",
        },
        {
          "type": "improvement",
          "detail": "Update the Atkinson Hyperlegible font to the new Atkinson Hyperlegible Next.",
        },
        {
          "type": "improvement",
          "detail": "Banners on the settings page now scroll with the rest of the items.",
        },
        {
          "type": "improvement",
          "detail": "Improved crash detection.",
        },
        {
          "type": "improvement",
          "detail": "New translations for Chinese, Dutch, French, Hungarian, Slovak, Spanish, and Ukrainian.",
          "additional":
              "Thanks @FaintGhost, @OrlandoSmits, @pfalarde, falarie_82, @ugyes, @vawaver, @Manre, and @Michael5564445",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      "changes": [
        ...
        {
          "type": "fix",
          "detail": "Re-enabled donation code as it is no longer conflicting with notification code.",
        },
      ],
    },
    {
      ...
      "changes": [
        ...
        },
        {
          "type": "fix",
          "detail":
              "Temporarily disable in-app update check due to issues with package used providing incorrect results.",
        },
      ],
    },
    {
      ...
      "changes": [
        ...
        {
          "type": "new",
          "detail": "Added the ability to receive OTA updates for troubleshooting difficult issues.",
        },
        {
          "type": "improvement",
      ...
      "changes": [
        {
          "type": "improvement",
          "detail":
              "Adjusted post-update registration to avoid possible race condition that would clear OneSignal Device ID.",
      ...
      "changes": [
        {
          "type": "new",
          "detail":
              "Tautulli Remote now has themes, choose a color to inspire the look of the app. Android users can also leverage their system theme color.",
        ...
        },
        {
          "type": "new",
          "detail":
              "Tapping a notification for watched or recently added items will open up the history and recently added pages respectively.",
        },
        {
          "type": "new",
        ...
        },
        {
          "type": "fix",
          "detail":
              "Quick actions will no longer cause the inner drawer to consistently force close if the app was already open on the quick action destination.",
        },
        {
          "type": "fix",
    ...
    },
    {
      ...
      "changes": [
        ...
        },
        {
          "type": "new",
          "detail":
              "The app has had an entire visual overhaul, improving look, usability, and bringing it more in line with Material Design 3.",
        ...
        },
        {
          "type": "new",
          "detail":
              "You can long press the app icon to select a quick action and jump to activity, history, recently added, or settings.",
        },
        {
          "type": "new",
    ...
    },
    {
      ...
      "changes": [
        ...
        {
          "type": "fix",
          "detail": "iOS notifications would wait to time out before displaying.",
        },
        {
          "type": "fix",
    ...
    },
    {
      ...
      "changes": [
        {
          "type": "improvement",
          "detail": "When a synced item has multiple rating keys use the first one to load the poster.",
        },
        {
          "type": "fix",
          "detail":
    ...
    },
    {
      ...
      "changes": [
        ...
        {
          "type": "improvement",
          "detail": "Add additional customization to MaterialStylePosterCard widget.",
        },
        {
          "type": "improvement",
      ...
      "changes": [
        {
          "type": "improvement",
          "detail":
              "Show generic 'Unknown error' in Activity MaterialStyleStatusCard when there is no failure mapping.",
        },
        {
          "type": "improvement",
