...
class CupertinoStyleStreamTypeGraphsTab extends StatelessWidget {
  const CupertinoStyleStreamTypeGraphsTab({super.key});
          ...
          sliver: SliverList(
            delegate: SliverChildListDelegate(
              [
                ...
                const Gap(18),
                CupertinoStyleGraphHeading(text: LocaleKeys.daily_concurrent_stream_count_by_stream_type_title.tr()),
                CupertinoStyleGraphCard(
                  graphChartType: GraphChartType.line,
