...
class CupertinoStyleMovieMediaPage extends StatelessWidget {
  final ServerModel server;
  final MediaModel media;
  final String? previousPageTitle;

  const CupertinoStyleMovieMediaPage({
    super.key,
  ...
  Widget build(BuildContext context) {
    return CupertinoStyleMovieMediaView(
      server: server,
      media: media,
...
class CupertinoStyleMovieMediaView extends StatelessWidget {
  final ServerModel server;
  final MediaModel media;
  final String? previousPageTitle;
  final bool disableAncestryNavigation;

  const CupertinoStyleMovieMediaView({
    super.key,
    required this.server,
    required this.media,
    required this.previousPageTitle,
