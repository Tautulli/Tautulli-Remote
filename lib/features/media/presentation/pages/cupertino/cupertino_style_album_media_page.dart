...
class CupertinoStyleAlbumMediaPage extends StatelessWidget {
  ...
  const CupertinoStyleAlbumMediaPage({
    super.key,
  ...
  Widget build(BuildContext context) {
    return CupertinoStyleAlbumMediaView(
      server: server,
      media: media,
...
class CupertinoStyleAlbumMediaView extends StatelessWidget {
  final ServerModel server;
  final MediaModel media;
  final String? previousPageTitle;
  final bool disableAncestryNavigation;

  const CupertinoStyleAlbumMediaView({
    super.key,
    required this.server,
    required this.media,
    required this.previousPageTitle,
      ...
      builder: (context, settingsState) {
        ...
        return CupertinoStyleTabbedPosterDetailsPage(
          ...
          segments: {
            ...
            1: const Text(LocaleKeys.tracks_title).tr(),
