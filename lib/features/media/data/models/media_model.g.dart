...
MediaModel _$MediaModelFromJson(Map<String, dynamic> json) => MediaModel(
  ...
  duration: MediaModel.durationFromMilliseconds(json['duration'] as String?),
  ...
  updatedAt: MediaModel.dateTimeFromEpochSeconds(json['updated_at'] as String?),
...
Map<String, dynamic> _$MediaModelToJson(
  MediaModel instance,
) => <String, dynamic>{
