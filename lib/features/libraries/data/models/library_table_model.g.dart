...
LibraryTableModel _$LibraryTableModelFromJson(
  ...
  duration: LibraryTableModel.durationFromSeconds(
  ...
  lastAccessed: LibraryTableModel.dateTimeFromEpochSeconds(
    (json['last_accessed'] as num?)?.toInt(),
  ),
...
Map<String, dynamic> _$LibraryTableModelToJson(
  LibraryTableModel instance,
) => <String, dynamic>{
