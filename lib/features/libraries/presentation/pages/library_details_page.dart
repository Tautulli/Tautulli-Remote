...
class LibraryDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SliverTabbedDetails(
            ...
            child: BlocBuilder<SettingsBloc, SettingsState>(
              builder: (context, state) {
                ...
                return CachedNetworkImage(
                  imageUrl: libraryTableModel.backgroundUri.toString(),
                  httpHeaders: {
      ...
      icon: LibraryDetailsIcon(libraryTableModel: libraryTableModel),
      title: libraryTableModel.sectionName ?? '',
      subtitle: RichText(
        text: TextSpan(
          children: [
            ...
            const TextSpan(text: ' '),
            TextSpan(
              text: TimeHelper.moment(libraryTableModel.lastAccessed),
              style: TextStyle(
