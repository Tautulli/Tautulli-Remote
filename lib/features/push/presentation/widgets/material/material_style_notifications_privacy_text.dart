...
class MaterialStyleNotificationsPrivacyText extends StatefulWidget {
  const MaterialStyleNotificationsPrivacyText({super.key});

  @override
  State<MaterialStyleNotificationsPrivacyText> createState() => _MaterialStyleNotificationsPrivacyTextState();
}

class _MaterialStyleNotificationsPrivacyTextState extends State<MaterialStyleNotificationsPrivacyText> {
