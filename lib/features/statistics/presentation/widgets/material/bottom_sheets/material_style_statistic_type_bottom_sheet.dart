...
class MaterialStyleStatisticTypeBottomSheet extends StatelessWidget {
  final PlayMetricType initialValue;

  const MaterialStyleStatisticTypeBottomSheet({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialStyleBottomSheetScaffold(
      title: LocaleKeys.statistic_type_title.tr(),
      child: ClipRRect(
