...
HistoryModel _$HistoryModelFromJson(Map<String, dynamic> json) => HistoryModel(
  date: HistoryModel.dateTimeFromEpochSeconds((json['date'] as num?)?.toInt()),
  duration: HistoryModel.durationFromJson((json['duration'] as num?)?.toInt()),
  ...
  pausedCounter: HistoryModel.durationFromJson(
    (json['paused_counter'] as num?)?.toInt(),
  ),
  ...
  started: HistoryModel.dateTimeFromEpochSeconds(
    (json['started'] as num?)?.toInt(),
  ),
  state: Cast.castStringToPlaybackState(json['state'] as String?),
  stopped: HistoryModel.dateTimeFromEpochSeconds(
    (json['stopped'] as num?)?.toInt(),
  ),
  ...
  watchedStatus: HistoryModel.watchedStatusFromDouble(
