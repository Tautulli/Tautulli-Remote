...
RecentlyAddedModel _$RecentlyAddedModelFromJson(
  ...
  directors: RecentlyAddedModel.stringListfromList(json['directors'] as List?),
  duration: RecentlyAddedModel.durationFromJson(json['duration'] as String?),
...
Map<String, dynamic> _$RecentlyAddedModelToJson(
  RecentlyAddedModel instance,
) => <String, dynamic>{
