...
ActivityModel _$ActivityModelFromJson(Map<String, dynamic> json) =>
    ActivityModel(
      ...
      audioDecision: Cast.castStringToStreamDecision(
      ...
      videoDecision: Cast.castStringToStreamDecision(
...
Map<String, dynamic> _$ActivityModelToJson(
  ActivityModel instance,
) => <String, dynamic>{
