...
import 'dialogs/secondary_connection_address_info_ios_dialog.dart';

class ServerRegistrationIosStepTwo extends StatefulWidget {
  final TextEditingController primaryController;
  final TextEditingController secondaryController;
  final TextEditingController tokenController;

  const ServerRegistrationIosStepTwo({
    super.key,
  ...
  @override
  State<ServerRegistrationIosStepTwo> createState() => _ServerRegistrationIosStepTwoState();
}

class _ServerRegistrationIosStepTwoState extends State<ServerRegistrationIosStepTwo> {
