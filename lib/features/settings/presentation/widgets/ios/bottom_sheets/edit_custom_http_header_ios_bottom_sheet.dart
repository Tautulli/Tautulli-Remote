...
class EditCustomHttpHeaderIosBottomSheet extends StatefulWidget {
  final bool forRegistration;
  final String existingKey;
  final String existingValue;
  final String? tautulliId;

  const EditCustomHttpHeaderIosBottomSheet({
    super.key,
  ...
  @override
  State<EditCustomHttpHeaderIosBottomSheet> createState() => _EditCustomHttpHeaderIosBottomSheetState();
}

class _EditCustomHttpHeaderIosBottomSheetState extends State<EditCustomHttpHeaderIosBottomSheet> {
