...
class CustomHttpHeaderIosBottomSheet extends StatefulWidget {
  ...
  const CustomHttpHeaderIosBottomSheet({
    super.key,
  ...
  @override
  State<CustomHttpHeaderIosBottomSheet> createState() => _CustomHttpHeaderIosBottomSheetState();
}

class _CustomHttpHeaderIosBottomSheetState extends State<CustomHttpHeaderIosBottomSheet> {
