...
class MaterialStyleServerRegistrationStepTwo extends StatefulWidget {
  final TextEditingController primaryController;
  final TextEditingController secondaryController;
  final TextEditingController tokenController;

  const MaterialStyleServerRegistrationStepTwo({
    super.key,
  ...
  @override
  State<MaterialStyleServerRegistrationStepTwo> createState() => MaterialStyleServerRegistrationStepTwoState();
}

class MaterialStyleServerRegistrationStepTwoState extends State<MaterialStyleServerRegistrationStepTwo> {
                ...
                child: IconButton(
                  ...
                  onPressed: () async {
                    await showDialog(
                      context: context,
                      builder: (context) {
                        return const MaterialStyleSecondaryConnectionAddressInfoDialog();
                      },
                    );
                  },
                ),
