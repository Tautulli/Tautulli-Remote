...
class MaterialStyleCustomHeaderConfigDialog extends StatefulWidget {
  ...
  const MaterialStyleCustomHeaderConfigDialog({
    super.key,
  ...
  @override
  State<MaterialStyleCustomHeaderConfigDialog> createState() => _CustomHeaderConfigDialogState();
}

class _CustomHeaderConfigDialogState extends State<MaterialStyleCustomHeaderConfigDialog> {
