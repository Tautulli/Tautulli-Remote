...
class MaterialStyleLanguageDialog extends StatefulWidget {
  final Locale initialValue;

  const MaterialStyleLanguageDialog({
    super.key,
    required this.initialValue,
  });

  @override
  MaterialStyleLanguageDialogState createState() => MaterialStyleLanguageDialogState();
}

class MaterialStyleLanguageDialogState extends State<MaterialStyleLanguageDialog> {
  late Locale _locale;
