...
import 'material_style_custom_header_config_dialog.dart';

class MaterialStyleCustomHeaderTypeDialog extends StatelessWidget {
  final bool forRegistration;
  final String? tautulliId;
  final List<CustomHeaderModel>? currentHeaders;

  const MaterialStyleCustomHeaderTypeDialog({
    super.key,
